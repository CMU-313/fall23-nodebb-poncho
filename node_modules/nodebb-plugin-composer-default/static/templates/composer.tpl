		...
		<div class="row title-container">
			...
			<div class="btn-group pull-right action-bar hidden-sm hidden-xs">
				...
				<ul class="dropdown-menu">
					<li>
						<button class="btn btn-default composer-anonymousSubmitStudent">
							Post Anonymously to Students
						</button>

						<button class="btn btn-default composer-anonymousSubmitInstructor">
							Post Anonymously to Instructors
						</button>

						<button class="btn btn-default composer-anonymousSubmit">
							Post Anonymously to Both
						</button>
					</li>
				</ul>

				<button class="btn btn-primary composer-submit" data-action="post" tabindex="6" data-text-variant=" [[topic:composer.schedule]]">
